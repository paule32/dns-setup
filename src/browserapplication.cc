...
extern QWidget*     my_application_browser_widget;
BrowserMainWindow * my_application_browser = nullptr;
...
//    connect(this, SIGNAL(lastWindowClosed()), this, SLOT(my_exit()));
...
void BrowserApplication::hideEvent(QHideEvent *ev)
{
QMessageBox::information(0,"wsww","1212");
    my_application_browser_widget->hide();

}

void BrowserApplication::my_exit()
{
QMessageBox::information(0,"wsww","1212121121212");
    my_application_browser_widget->hide();
}
...
{
    BrowserMainWindow *browser = new BrowserMainWindow(my_application_browser_widget);
    m_mainWindows.prepend(browser);
    browser->move(17,35);
    browser->resize(990,680);
